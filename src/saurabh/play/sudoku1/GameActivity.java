...
public class GameActivity extends Activity {
	...
	public static final String KEY_DIFFICULTY="saurabh.play.sudoku1.difficulty";
	...
	protected void showKeypadOrError(int x, int y)
	{
		...
		{
			Log.d(TAG, "shoeKeypad : useds="+ toPuzzleString(tiles));
	...
	private final String mediumPuzzle = "650000070000506000014000005"+"007009000002314700000700800"+"5000006300000000201000030000097";
